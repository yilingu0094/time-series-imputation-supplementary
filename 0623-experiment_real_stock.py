    ...
    if param == 'delta':
        ...
        for k in range(config_rs.n_experiment):
            ...
            for i in range(config_rs.num_delta):
                ...
                _,final_mu_kl_back,final_sigma_kl_back = utils_rs.consensusbackwardkl(meanlist,covariancelist,deltalist_complex[i],meanlist[0],np.full(len(meanlist),1/len(meanlist)),10**(-15),50,rholist_complex[hyperparam],'Vz-l1-norm')
        ...
        plt.show()
        plt.savefig(config_rs.epspath + "/{}_rho={}_g1.eps".format(param,rholist_complex[hyperparam]),format='eps')
        plt.clf()
        ...
        plt.legend(fontsize=15)
        plt.show()
        plt.savefig(config_rs.epspath + "/{}_rho={}_g2.eps".format(param,rholist_complex[hyperparam]),format='eps')
        plt.clf()
        ...
        plt.legend(fontsize=15)
        plt.show()
        plt.savefig(config_rs.epspath + "/{}_rho={}_g3.eps".format(param,rholist_complex[hyperparam]),format='eps')
        plt.clf()
        ...
        plt.legend(fontsize=15)
        plt.show()
        plt.savefig(config_rs.epspath + "/{}_rho={}_g4.eps".format(param,rholist_complex[hyperparam]),format='eps')
        plt.clf()
        ...
        plt.legend(fontsize=15)
        plt.show()
        plt.savefig(config_rs.epspath + "/{}_rho={}_g5.eps".format(param,rholist_complex[hyperparam]),format='eps')
        plt.clf()
    ...
    if param == 'rho':
        ...
        for k in range(config_rs.n_experiment):
            ...
            for i in range(config_rs.num_rho):
                ...
                _,final_mu_kl_back,final_sigma_kl_back = utils_rs.consensusbackwardkl(meanlist,covariancelist,deltalist_complex[hyperparam],meanlist[0],np.full(len(meanlist),1/len(meanlist)),10**(-15),50,rholist_complex[i],'Vz-l1-norm')
                completed_data_kl_back = utils_rs.imputation(data,mask,final_mu_kl_back,final_sigma_kl_back)
        ...
        plt.legend(fontsize=15)
        plt.show()
        plt.savefig(config_rs.epspath + "/{}_delta={}_g1.eps".format(param,rholist_complex[hyperparam]),format='eps')
        plt.clf()
        ...
        plt.legend(fontsize=15)
        plt.show()
        plt.savefig(config_rs.epspath + "/{}_delta={}_g2.eps".format(param,rholist_complex[hyperparam]),format='eps')
        plt.clf()
        ...
        plt.legend(fontsize=15)
        plt.show()
        plt.savefig(config_rs.epspath + "/{}_delta={}_g3.eps".format(param,rholist_complex[hyperparam]),format='eps')
        plt.clf()
        ...
        plt.legend(fontsize=15)
        plt.show()
        plt.savefig(config_rs.epspath + "/{}_delta={}_g4.eps".format(param,rholist_complex[hyperparam]),format='eps')
        plt.clf()
        ...
        plt.legend(fontsize=15)
        plt.show()
        plt.savefig(config_rs.epspath + "/{}_delta={}_g5.eps".format(param,rholist_complex[hyperparam]),format='eps')
        plt.clf()
...
def specific_experiment(param, hyperparam):
    ...
    if param == 'delta':
        ...
        plt.legend(fontsize=15)
        plt.show()
        plt.savefig(config_rs.epspath + "/{}_rho={}_s1.eps".format(param,rholist_complex[hyperparam]),format='eps')
        plt.clf()
        ...
        plt.legend(fontsize=15)
        plt.show()
        plt.savefig(config_rs.epspath + "/{}_rho={}_s2.eps".format(param,rholist_complex[hyperparam]),format='eps')
        plt.clf()
        ...
        plt.legend(fontsize=15)
        plt.show()
        plt.savefig(config_rs.epspath + "/{}_rho={}_s3.eps".format(param,rholist_complex[hyperparam]),format='eps')
        plt.clf()
        ...
        plt.legend(fontsize=15)
        plt.show()
        plt.savefig(config_rs.epspath + "/{}_rho={}_s4.eps".format(param,rholist_complex[hyperparam]),format='eps')
        plt.clf()
        ...
        plt.legend(fontsize=15)
        plt.show()
        plt.savefig(config_rs.epspath + "/{}_rho={}_s5.eps".format(param,rholist_complex[hyperparam]),format='eps')
        plt.clf()
    ...
    if param == 'rho':
        ...
        plt.legend(fontsize=15)
        plt.show()
        plt.savefig(config_rs.epspath + "/{}_delta={}_s1.eps".format(param,rholist_complex[hyperparam]),format='eps')
        plt.clf()
        ...
        plt.legend(fontsize=15)
        plt.show()
        plt.savefig(config_rs.epspath + "/{}_delta={}_s2.eps".format(param,rholist_complex[hyperparam]),format='eps')
        plt.clf()
        ...
        plt.legend(fontsize=15)
        plt.show()
        plt.savefig(config_rs.epspath + "/{}_delta={}_s3.eps".format(param,rholist_complex[hyperparam]),format='eps')
        plt.clf()
        ...
        plt.legend(fontsize=15)
        plt.show()
        plt.savefig(config_rs.epspath + "/{}_delta={}_s4.eps".format(param,rholist_complex[hyperparam]),format='eps')
        plt.clf()
        ...
        plt.legend(fontsize=15)
        plt.show()
        plt.savefig(config_rs.epspath + "/{}_delta={}_s5.eps".format(param,rholist_complex[hyperparam]),format='eps')
        plt.clf()
